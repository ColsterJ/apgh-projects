# Bonus - Add ability to delete messages
#   ^ set existing to Nil, when creating message loop through and if Nil that can be the message slot
#   ^ Or, Drew's solution is to simply ask for desired id and then set array[idTheyWanted] = the Thing
...
while keep_running
    ...
    if input == "1"
        ...
        # end
        puts "Your message ID is #{messages.length-1}"
    elsif input == "2"
